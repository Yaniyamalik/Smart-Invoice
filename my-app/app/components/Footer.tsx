  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      ...
      <nav className="grid grid-flow-col gap-4">
        ...
        <a className="link link-hover">Predict Freight</a>
        <a className="link link-hover">Invoice Flagging</a>
        <a className="link link-hover">Bulk Analysist</a>
      </nav>
      ...
      <aside>
        <p>
          Copyright © {new Date().getFullYear()} - All rights reserved by SmartInvoice
        </p>
      </aside>
    </footer>
  );
